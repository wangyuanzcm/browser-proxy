! function(a) {
    ...
    i.m = a, i.c = o, i.d = function(a, o, e) {
        ...
        if (i.r(e), Object.defineProperty(e, "default", {
            ...
            for (var n in a) i.d(e, n, function(o) {
                return a[o]
            }.bind(null, n));
        return e
    }, i.n = function(a) {
    ...
    function m(a) {
        ...
        return {
            attr: function(a, i, ...e) {
                ...
                })), r(i, "setAttributeNode", a => (function(o) {
    ...
    function u(a, o) {
        return `${o}${function(a){return/^(localhost|127\.\d+\.\d+\.\d+)([:\/]|$)/.test(a)}(a)?"":"s"}://${a}/${o}`
    }
    ...
    function p(a) {
        ...
        for (const [o, i] of Object.entries(a.node_map)) {
            const a = [];
            let e = 0;
            for (const [o, n] of Object.entries(i.lines)) e += n, a.push({
                host: o,
                weight: n
            });
    ...
    function s(a) {
        let o = n.get(a);
        return void 0 !== o ? o : (o = Object(e.d)(a) ? a : function(a) {
            if (r(a)) return a;
            let o = 0;
            for (;;) {
    ...
    function b(a, o) {
        ! function(a, o) {
            ...
            s.d(u, "key", r), s.d(u, "url", a => (function() {
                const o = a.call(this);
                return e.c(o)
            }));
        ...
        })), p("Worker"), p("SharedWorker"), s.c(a, "importScripts", a => (function(...o) {
            const i = o.map(e.i);
    ...
    }(e) : "onfetch" in e ? (n.h(n.b), i(15)) : function(a) {
        n.h(n.c), i(12).init(a, location.origin), a.__set_srcWin = function() {
            return []
        }
    }(e)
}, function(a, o, i) {
    ...
    function g(a) {
        ...
        const {
            location: h,
            navigator: d
        } = a, j = new URL(o.baseURI), b = r.b(a);
        c.d(a, {
            loc: h,
            doc: o,
            ori: j,
            domHook: b
        }), p.init(a, j.origin), k(a, b);
        ...
        ! function() {
            ...
            i ? (v = function() {
                w(e.f, i)
            }, w(e.e, i), w(e.d)) : console.warn("[jsproxy] missing page id")
        ...
        }), r.c(d, "registerProtocolHandler", a => (function(o, i, e) {
        ...
        }), r.d($, "contentWindow", a => (function() {
            const o = a.call(this);
            return g(o), o
        })), r.d($, "contentDocument", a => (function() {
            const o = a.call(this);
            return o && g(o.defaultView), o
        })), D(P), D(T), r.c(W, "submit", a => (function() {
        ...
        try {
            return await async function(a, o) {
                ...
                const n = await e.arrayBuffer(),
                    ...
                    p = JSON.parse(c),
                    l = t.subarray(2 + r);
                return p.date = (new Date).toUTCString(), new Response(l, {
                    headers: p
                })
            }(a, o)
        } catch (a) {
    ...
    function R(a, o, i) {
        ...
        x && (n["--aceh"] = "1"), a.headers.forEach((a, o) => {
            "user-agent" !== o && (! function(a, o) {
                return "content-type" === a ? "application/x-www-form-urlencoded" === o || "multipart/form-data" === o || "text/plain" === o : "accept" === a || "accept-language" === a || "content-language" === a ? o.length < 256 && !S.test(o) : void 0
            }(o, a) ? n[o] = a : e.set(o, a))
        }), n.origin && (n.origin = i.origin);
        const s = a.referrer;
        return s && (n.referer = s === y ? i.origin + "/" : t.c(s)), n.cookie = function(a, o, i) {
    ...
    async function oa(a, o) {
        const i = a.clientId;
        let e;
        i && (e = Z.get(i) || await async function(a) {
        ...
        try {
            ...
            return console.error(a), X("前端脚本错误<br><pre>" + a.stack + "</pre>", 500)
        }
    }
    let ia, ea;
    async function na() {
        ia = new f.a(".sys"), await ia.open({
            "url-cache": {
                keyPath: "url"
            },
            cookie: {
    ...
    function ta(a, o) {
        if (!o && I) {
            ...
            W = a
        }(a), n.d(a), _(a), F = function(a) {
            const o = {};
            if (!a) return o;
            for (const [i, e] of Object.entries(a)) o[i] = e;
            return o
        }(a.url_handler), async function(a) {
